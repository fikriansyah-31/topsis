<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-0 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-r-2xl border-0 bg-white p-0 antialiased shadow-lg transition-transform duration-200 xl:left-0 xl:translate-x-0">
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-dark" href="#" target="_blank">
            <img src="{{ asset('img/man.png') }}" class="inline h-full max-w-full max-h-12 rounded-full transition-all duration-200 ease-nav-brand" alt="main_logo" />
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">SPK PEGAWAI</span>
        </a>
    </div>
    ...
    <ul class="flex flex-col pl-0 mb-5">
        ...
        <li class="w-full mt-6">
            <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs opacity-60">Profile Matching</h6>
        </li>

        <li class="mt-0.5 w-full">
            <a href="{{ route('penilaian.pm') }}" class="{{ Request::is('dashboard/pm-penilaian') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-dark' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                <div class="{{ Request::is('dashboard/pm-penilaian') ? 'bg-gradient-to-tl from-backgroundSecondary to-greenSecondary text-white' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                    <i class="ri-survey-fill text-greenPrimary"></i>
                </div>
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Penilaian</span>
            </a>
        ...
        <li class="mt-0.5 w-full">
            <a href="{{ route('perhitungan.pm') }}" class="{{ Request::is('dashboard/pm-perhitungan') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-dark' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                <div class="{{ Request::is('dashboard/pm-perhitungan') ? 'bg-gradient-to-tl from-backgroundSecondary to-greenSecondary text-white' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                    <i class="ri-calculator-fill text-greenPrimary"></i>
                </div>
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Perhitungan</span>
            </a>
        ...
        <li class="mt-0.5 w-full">
            <a href="{{ route('perhitungan.pm.hasil') }}" class="{{ Request::is('dashboard/pm-perhitungan/hasil-akhir') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-dark' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                <div class="{{ Request::is('dashboard/pm-perhitungan/hasil-akhir') ? 'bg-gradient-to-tl from-backgroundSecondary to-greenSecondary text-white' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                    <i class="ri-bar-chart-2-fill text-greenPrimary"></i>
                </div>
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Hasil Akhir</span>
            </a>
        ...
        <li class="w-full mt-6">
            <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs opacity-60">Perbandingan</h6>
        </li>

        <li class="mt-0.5 w-full">
            <a href="{{ route('perbandingan') }}" class="{{ Request::is('dashboard/perbandingan') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-dark' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors">
                <div class="{{ Request::is('dashboard/perbandingan') ? 'bg-gradient-to-tl from-backgroundSecondary to-greenSecondary text-white' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                    <i class="ri-bar-chart-2-fill text-greenPrimary"></i>
                </div>
                <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Perbandingan</span>
            </a>
        </li>
    </ul>
</aside>
